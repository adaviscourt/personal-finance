...
- Support Vercel project deployment to a subdomain of an existing site without requiring a separate fork or copied app implementation.
...
- Backend/configuration need a demo-mode flag and seed data path suitable for Vercel-hosted public demos.
